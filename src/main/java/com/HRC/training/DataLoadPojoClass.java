...
public class DataLoadPojoClass {
	...
	public void setCustomer_no(int cust_number) {
	...
	public double getTotal_open_amt() {
		return total_open_amount;
	}
	public void setTotal_open_amt(double total_open_amount) {
	...
	public void setCustomer_payment_terms(String cust_payment_terms) {
	...
	public DataLoadPojoClass(int sl_no, String business_code, int cust_number, String clear_date, String buisness_year, String doc_id,
